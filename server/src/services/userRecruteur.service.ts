...
import { ADMIN, CFA, ENTREPRISE, ETAT_UTILISATEUR, OPCO, IOpcoLabel, VALIDATION_UTILISATEUR } from "shared/constants/recruteur"
...
export const getUserRecruteursForManagement = async ({ opco, activeRoleLimit }: { opco?: IOpcoLabel; activeRoleLimit?: number }) => {
