...
import { ADMIN, CFA, ENTREPRISE, ETAT_UTILISATEUR, OPCO, IOpco, VALIDATION_UTILISATEUR } from "shared/constants/recruteur"
...
export const getUserRecruteursForManagement = async ({ opco, activeRoleLimit }: { opco?: IOpco; activeRoleLimit?: number }) => {
