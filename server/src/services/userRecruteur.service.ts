...
import { createUser2IfNotExist } from "./userWithAccount.service"
...
export const updateUser2Fields = async (userId: ObjectIdType, fields: Partial<IUserWithAccount>): Promise<IUserWithAccount | { error: BusinessErrorCodes }> => {
