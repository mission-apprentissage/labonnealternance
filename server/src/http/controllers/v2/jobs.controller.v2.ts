  ...
  server.post(
    ...
    async (req, res) => {
      ...
      const job: IJobsPartnersOfferPrivate = {
        ...
        offer_desired_skills: rest.offer_desired_skills ?? [],
        offer_to_be_acquired_skills: rest.offer_to_be_acquired_skills ?? [],
        offer_access_conditions: rest.offer_access_conditions ?? [],
