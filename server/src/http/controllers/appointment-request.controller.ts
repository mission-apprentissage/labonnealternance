...
import { createRdvaShortRecapToken } from "@/services/app-links.service"
...
import { findElligibleTrainingForAppointment, getParameterByCleMinistereEducatif } from "@/services/eligible-trainings-for-appointment.service"
