...
import { ICreateDelegation, ICreateJobBody, IGetDelegation, TCreateEstablishmentBody, TEstablishmentResponseSuccess, TJob, TResponseError } from "./jobs.types.ts"
import { createDelegationSchema, createJobEntitySchema, createJobSchema, getEstablishmentEntitySchema, updateJobSchema } from "./jobs.validators.ts"
import { formatEntrepriseData, getEtablissement, getEtablissementFromGouv, getGeoCoordinates } from "../../../services/etablissement.service.ts"
import { Recruiter } from "../../../common/model/index.ts"
import { createUser, updateUserValidationHistory } from "../../../services/userRecruteur.service.ts"
import { IUserRecruteur } from "../../../common/model/schema/userRecruteur/userRecruteur.types.ts"
import { cancelOffre, createJobDelegations, createOffre, extendOffre, getFormulaire, getFormulaires, patchOffre, provideOffre } from "../../../services/formulaire.service.ts"
import { IJobs } from "../../../common/model/schema/jobs/jobs.types.ts"
import dayjs from "../../../common/dayjs.ts"
import { getAppellationDetailsFromAPI, getRomeDetailsFromAPI } from "../../../services/rome.service.ts"
import { getOffre } from "../../../services/formulaire.service.ts"
import { getNearEtablissementsFromRomes } from "../../../services/catalogue.service.ts"
import { ENTREPRISE, etat_utilisateur, validation_utilisateur } from "../../../common/constants.ts"
import { delay } from "../../../common/utils/asyncUtils.ts"
import { ICredential } from "../../../common/model/schema/credentials/credential.types.ts"
import { IApiError } from "../../../common/utils/errorManager.ts"
import { ILbaItem } from "../../../services/lbaitem.shared.service.types.ts"
import { getCompanyFromSiret } from "../../../service/poleEmploi/bonnesBoites.ts"
import { getMatchaJobById } from "../../../service/matcha.ts"
import { getPeJobFromId } from "../../../service/poleEmploi/offresPoleEmploi.ts"
import { getJobsQuery } from "../../../service/poleEmploi/jobsAndCompanies.ts"
