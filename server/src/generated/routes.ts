...
const models: TsoaRoute.Models = {
  ...
  Partial_ILbaItemPlace_: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        distance: { dataType: "union", subSchemas: [{ dataType: "double" }, { dataType: "enum", enums: [null] }] },
        fullAddress: { dataType: "union", subSchemas: [{ dataType: "string" }, { dataType: "enum", enums: [null] }] },
        latitude: { dataType: "union", subSchemas: [{ dataType: "string" }, { dataType: "enum", enums: [null] }] },
        longitude: { dataType: "union", subSchemas: [{ dataType: "string" }, { dataType: "enum", enums: [null] }] },
  ...
  ILbaItem: {
    ...
    properties: {
      ...
      romes: {
        dataType: "union",
        subSchemas: [
          { dataType: "array", array: { dataType: "refObject", ref: "ILbaItemRome" } },
      ...
      nafs: {
        dataType: "union",
        subSchemas: [
          { dataType: "array", array: { dataType: "refObject", ref: "ILbaItemNaf" } },
          { dataType: "enum", enums: [null] },
        ],
        required: true,
      },
