import { processEdf } from "@/jobs/offrePartenaire/edf/process-edf"
import { processEnedis } from "@/jobs/offrePartenaire/enedis/process-enedis"
import { processMissingRomeAndImportToJobPartners } from "@/jobs/offrePartenaire/process-missing-rome-and-import-to-job-partners"
import { analyzeCfaBlockList } from "@/jobs/oneTimeJob/analyze-cfa-block-list"
...
import { updateDiplomeMetier } from "./diplomesMetiers/update-diplomes-metiers"
import { buildMappingRomeRNCP } from "./domainesMetiers/build-mapping-rome-rncp"
import {
  analyzeRemovedRomes,
  classifyRomesForDomainesMetiers,
  classifyRomesForDomainesMetiersAnalyze,
  findDomainesMetiersIncoherents,
} from "./domainesMetiers/classify-romes-for-domaines-metiers"
import { importFichesRncp } from "./domainesMetiers/import-fiches-rncp"
import { updateRomesForDomainesMetiers } from "./domainesMetiers/update-romes-for-domaines-metiers"
import { validateDomaineMetiers } from "./domainesMetiers/validate-domaine-metiers"
import {
  refreshEntrepriseEngagementJobsPartners,
  refreshReferentielEngagementFranceTravail,
  refreshReferentielEtEntrepriseEngagement,
} from "./engagementHandicap/refresh-entreprise-engagement-jobs-partners"
import { importCatalogueFormationJob } from "./formationsCatalogue/formations-catalogue"
import { updateParcoursupAndAffelnetInfoOnFormationCatalogue } from "./formationsCatalogue/update-parcoursup-and-affelnet-info-on-formation-catalogue"
import { generateFranceTravailAccess } from "./franceTravail/generate-france-travail-access"
import { createRoleManagement360 } from "./metabase/metabase-role-management360"
import { sendMiseEnRelation } from "./miseEnRelation/send-mise-en-relation"
import { processApec } from "./offrePartenaire/apec/process-apec"
import { processAtlas, processMeteojob, processNosTalentsNosEmplois, processToulouseMetropole, processViteUnEmploi } from "./offrePartenaire/clever-connect/process-clever-connect"
import { closeJobsPartnersOnApplicationThreshold } from "./offrePartenaire/close-jobs-partners-on-application-threshold"
import { processDecathlon } from "./offrePartenaire/decathlon/import-decathlon"
import { detectClassificationJobsPartners } from "./offrePartenaire/detect-classification-jobs-partners"
import { processEmploiInclusion } from "./offrePartenaire/emploi-inclusion/import-emploi-inclusion"
import { processEngagementJeunes } from "./offrePartenaire/engagementJeunes/import-engagement-jeunes"
import { processEtudiant } from "./offrePartenaire/etudiant/process-etudiant"
import { expireJobsPartners } from "./offrePartenaire/expire-jobs-partners"
import { fillEntrepriseEngagementJobsPartners } from "./offrePartenaire/fill-entreprise-engagement-jobs-partners"
import { fillLbaUrl, renewLbaUrl } from "./offrePartenaire/fill-lba-url"
import { processFranceTravail } from "./offrePartenaire/france-travail/process-france-travail"
import { processFranceTravailCEGID } from "./offrePartenaire/france-travail-CEGID/import-france-travail-cegid"
import { deduplicateHellowork } from "./offrePartenaire/hellowork-merge/deduplicate-hellowork"
import { processHellowork } from "./offrePartenaire/hellowork-merge/process-hellowork"
import { importFromComputedToJobsPartners } from "./offrePartenaire/import-from-computed-to-jobs-partners"
import { processJobteaser } from "./offrePartenaire/jobteaser/process-jobteaser"
import { processJooble } from "./offrePartenaire/jooble/process-jooble"
import { processKelio } from "./offrePartenaire/kelio/process-kelio"
import { processLaposte } from "./offrePartenaire/laposte/process-laposte"
import { processLeboncoin } from "./offrePartenaire/leboncoin/process-leboncoin"
import { processPass } from "./offrePartenaire/pass/process-pass"
import { processFillRomeStandalone } from "./offrePartenaire/process-fill-rome-standalone"
import {
...
} from "./offrePartenaire/process-job-partners"
import { processJobPartnersForApi } from "./offrePartenaire/process-job-partners-for-api"
import { removeMissingRecruteursLbaFromComputedJobPartners } from "./offrePartenaire/recruteur-lba/import-recruteurs-lba-raw"
import { cancelRemovedJobsPartnersRecruteursLba, processRecruteursLba, processRecruteursLbaRawToEnd } from "./offrePartenaire/recruteur-lba/process-recruteurs-lba"
import { processRhAlternance } from "./offrePartenaire/rh-alternance/process-rh-alternance"
import { analyzeClosedCompanies } from "./oneTimeJob/analyze-closed-companies"
import { cleanClosedCompanies } from "./oneTimeJob/clean-closed-companies"
import { renvoiMailCreationCompte } from "./oneTimeJob/renvoi-mail-creation-compte"
import { exportFileForAlgo } from "./partenaireExport/export-blacklist-algo"
import { sendContactsToBrevo } from "./partenaireExport/export-contacts-to-brevo"
import { exportLbaJobsToS3 } from "./partenaireExport/export-jobs-to-s3"
import { exportRecruteursToBrevo } from "./partenaireExport/export-recruters-to-brevo"
import { exportJobsToFranceTravail } from "./partenaireExport/export-to-france-travail"
...
import { importReferentielRome } from "./referentielRome/referentiel-rome"
