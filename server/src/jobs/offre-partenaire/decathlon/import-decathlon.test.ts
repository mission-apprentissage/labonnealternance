...
import { importDecathlonRaw, importDecathlonToComputed } from "./import-decathlon"

const now = new Date("2024-07-21T04:49:06.000+02:00")

describe("import-decathlon", () => {
  useMongo()
  ...
  it("should test the import of data into computed_job_partners", async () => {
    const fileStream = fs.createReadStream("server/src/jobs/offre-partenaire/decathlon/decathlon.test.input.json")
