...
import { importHelloWorkBuddiRaw, importHelloWorkBuddiToComputed } from "./import-hello-work-buddi"

const now = new Date("2024-07-21T04:49:06.000+02:00")

describe("import-hello-work-buddi", () => {
  useMongo()
  ...
  it("should test the import of hellowork Buddi data into computed_job_partners", async () => {
    const fileStream = fs.createReadStream("server/src/jobs/offre-partenaire/hellowork-buddi/import-hello-work-buddi.test.input.xml")
