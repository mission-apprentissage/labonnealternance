...
import type { OfferRef } from "./detect-duplicate-job-partners"
import { checkSimilarity, detectDuplicateJobPartners, isCanonicalForDuplicate } from "./detect-duplicate-job-partners"

const siret = "42476141900045"

describe("detect-duplicate-job-partners", () => {
  useMongo()
