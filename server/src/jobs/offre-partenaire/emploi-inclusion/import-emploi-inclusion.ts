...
import rawEmploiInclusionModel from "shared/models/raw-emploi-inclusion.model"
import { getAllEmploiInclusionJobsByDepartement, ZEmploiInclusionJob } from "@/common/apis/emploi-inclusion/emploi-inclusion.client"
