...
import type { IApecJob } from "./apec-mapper"
import { apecJobToJobsPartners } from "./apec-mapper"
...
describe("import-apec", () => {
  ...
  it("should import APEC data into raw_apec then computed_jobs_partners", async () => {
    const fileStream = fs.createReadStream("server/src/jobs/offre-partenaire/apec/import-apec.test.input.xml")
