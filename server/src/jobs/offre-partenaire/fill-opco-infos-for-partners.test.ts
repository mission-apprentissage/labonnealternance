...
import { generateFCOpcoResponseFixture, nockFranceCompetencesOpcoSearch } from "@/common/apis/france-competences/france-competences-client.fixture"
...
describe("fill-opco-infos-for-partners", () => {
  useMongo()
