...
import { generateRecruiterRawFixture } from "shared/fixtures/recruiter-raw.fixture"
...
const testDir = "server/src/jobs/offre-partenaire/recruteur-lba/__tests__"
...
describe("import-recruteurs-lba-raw", () => {
  beforeEach(async () => {
  ...
  it("should process all recruteurs", async () => {
    await processRecruteursLbaFromFile(`${testDir}/process-recruteurs-lba.test.1.json`)
