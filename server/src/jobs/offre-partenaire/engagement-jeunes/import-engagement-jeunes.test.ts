...
import { importEngagementJeunesRaw, importEngagementJeunesToComputed } from "./import-engagement-jeunes"

const now = new Date("2024-07-21T04:49:06.000+02:00")

describe("import-engagement-jeunes", () => {
  useMongo()
  ...
  it("should test the import of data into computed_job_partners", async () => {
    const fileStream = fs.createReadStream("server/src/jobs/offre-partenaire/engagement-jeunes/engagementJeunes.test.input.json")
