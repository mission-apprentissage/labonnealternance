...
const ZAtlasJobLocation = z.object({
  $: z.object({
    label: z.string(),
...
type IAtlasJobLocation = z.output<typeof ZAtlasJobLocation>

const CONTRAT_ALTERNANCE = "Alternance / Apprentissage"

export const ZAtlasJob = z
  .object({
    ...
    workplace: z.object({
      locations: z.object({
        location: z.union([ZAtlasJobLocation, z.array(ZAtlasJobLocation)]),
      }),
    }),
    contract: z.object({
      types: z.object({
...
export type IAtlasJob = z.output<typeof ZAtlasJob>

export const atlasJobToJobsPartners = (job: IAtlasJob): IComputedJobsPartners => {
...
const geolocToLatLon = (location: IAtlasJobLocation): IComputedJobsPartners["workplace_geopoint"] => {
