...
const CleverConnectDegreeMap: Record<string, IComputedJobsPartners["offer_target_diploma"]> = {
  bepc: { european: "3", label: NIVEAU_DIPLOME_LABEL["3"] },
  bep: { european: "3", label: NIVEAU_DIPLOME_LABEL["3"] },
  cap: { european: "3", label: NIVEAU_DIPLOME_LABEL["3"] },
  cqp: { european: "3", label: NIVEAU_DIPLOME_LABEL["3"] },
  bp: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  bac_pro: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  bac: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  "bac+1": { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  "bac+2": { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  deug: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  bts: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  dma: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  "bac+3": { european: "6", label: NIVEAU_DIPLOME_LABEL["6"] },
  license: { european: "6", label: NIVEAU_DIPLOME_LABEL["6"] },
  "bac+4": { european: "6", label: NIVEAU_DIPLOME_LABEL["6"] },
  maitrise: { european: "6", label: NIVEAU_DIPLOME_LABEL["6"] },
  "bac+5": { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  dea: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  master: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  business: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  engineering: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  mastere: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  phd: { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  "bac+7": { european: "7", label: NIVEAU_DIPLOME_LABEL["7"] },
  gcse_o_level: { european: "3", label: NIVEAU_DIPLOME_LABEL["3"] },
  a_level: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  t_level: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  btec_l3: { european: "4", label: NIVEAU_DIPLOME_LABEL["4"] },
  btec: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  dhe: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  foundation: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
  pgce: { european: "6", label: NIVEAU_DIPLOME_LABEL["6"] },
  cert_he: { european: "5", label: NIVEAU_DIPLOME_LABEL["5"] },
}
