...
const CleverConnectDegreeMap: Record<string, IComputedJobsPartners["offer_target_diploma"]> = {
  bepc: { european: "3", label: "CAP, BEP (Infrabac)" },
  bep: { european: "3", label: "CAP, BEP (Infrabac)" },
  cap: { european: "3", label: "CAP, BEP (Infrabac)" },
  cqp: { european: "3", label: "CAP, BEP (Infrabac)" },
  bp: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  bac_pro: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  bac: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  "bac+1": { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  "bac+2": { european: "5", label: "BTS, DEUST (Bac+2)" },
  deug: { european: "5", label: "BTS, DEUST (Bac+2)" },
  bts: { european: "5", label: "BTS, DEUST (Bac+2)" },
  dma: { european: "5", label: "BTS, DEUST (Bac+2)" },
  "bac+3": { european: "6", label: "Licence, BUT, Licence Pro (Bac+3)" },
  license: { european: "6", label: "Licence, BUT, Licence Pro (Bac+3)" },
  "bac+4": { european: "6", label: "Licence, BUT, Licence Pro (Bac+3)" },
  maitrise: { european: "6", label: "Licence, BUT, Licence Pro (Bac+3)" },
  "bac+5": { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  dea: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  master: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  business: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  engineering: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  mastere: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  phd: { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  "bac+7": { european: "7", label: "Master, titre ingénieur, grande école (Bac+5)" },
  gcse_o_level: { european: "3", label: "CAP, BEP (Infrabac)" },
  a_level: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  t_level: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  btec_l3: { european: "4", label: "Bac, Bac Pro, BP (Bac)" },
  btec: { european: "5", label: "BTS, DEUST (Bac+2)" },
  dhe: { european: "5", label: "BTS, DEUST (Bac+2)" },
  foundation: { european: "5", label: "BTS, DEUST (Bac+2)" },
  pgce: { european: "6", label: "Licence, BUT, Licence Pro (Bac+3)" },
  cert_he: { european: "5", label: "BTS, DEUST (Bac+2)" },
}
