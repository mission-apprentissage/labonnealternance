...
describe("importMeteojob", () => {
  ...
  it("should test the import of Meteojob data into computed_job_partners", async () => {
    const fileStream = fs.createReadStream("server/src/jobs/offrePartenaire/clever-connect/meteojob/importMeteojob.test.input.xml")
