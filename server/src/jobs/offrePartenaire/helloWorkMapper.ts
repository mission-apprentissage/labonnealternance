...
export const helloWorkJobToJobsPartners = (job: IHelloWorkJob): IComputedJobsPartners => {
  ...
  const partnerJob: IComputedJobsPartners = {
    ...
    offer_title: title,
    offer_description: description && description.length >= 25 ? description : undefined,
    ...
    workplace_description: company_description && company_description.length >= 25 ? company_description : null,
    workplace_size: null,
