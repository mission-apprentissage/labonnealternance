...
parcoursupEtablissementStatSchema.plugin(mongoosePagination)

export default model<IParcoursupEtablissementStat, Pagination<IParcoursupEtablissementStat>>("parcoursupEtablissementStat", parcoursupEtablissementStatSchema)
