          ...
          <Flex align='center' justify='space-between' direction={['column', 'column', 'column', 'row']}>
            <Box maxW='721px' mx={[0, 0, 0, 0 - 10]}>
              ...
              <Text color='#cecece' maxW='666px' mt={4}>
                Matcha et La Bonne Alternance fusionnent afin de proposer un service complet aux jeunes, aux entreprises
                et aux organismes de formation. Des modifications successives surviendront sur le site internet Matcha
