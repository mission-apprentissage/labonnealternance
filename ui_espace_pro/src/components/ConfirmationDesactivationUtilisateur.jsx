  ...
  return (
    <Modal closeOnOverlayClick={false} blockScrollOnMount={true} size='xl' isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent mt={['0', '3.75rem']} h={['100%', 'auto']} mb={0} borderRadius={0}>
        ...
        <ModalBody pb={6}>
          <Text>
            Vous êtes sur le point de désactiver le compte de l’entreprise {raison_sociale}. Une fois le compte inactif,
            l’entreprise ne pourra plus accéder au service de dépot d’offres et modifier ses informations.
          </Text>
          <FormControl isRequired mt={5}>
            ...
            <Select onChange={(e) => setMotif(e.target.value)}>
              ...
              <option value='Ne relève pas des champs de compétences de mon OPCO'>
                Ne relève pas des champs de compétences de mon OPCO
              </option>
