  ...
  return (
    <Modal closeOnOverlayClick={false} blockScrollOnMount={true} size='xl' isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent mt={['0', '3.75rem']} h={['100%', 'auto']} mb={0} borderRadius={0}>
        ...
        <ModalBody pb={6}>
          <Text>
            Vous êtes sur le point d’activer le compte de l’entreprise {raison_sociale}. Une fois le compte validé,
            l’entreprise pourra accéder au service de dépot d’offres et modifier ses informations.
          </Text>
        </ModalBody>
