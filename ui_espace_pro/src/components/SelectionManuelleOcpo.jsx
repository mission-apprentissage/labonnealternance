      ...
      <SimpleGrid columns={1} spacing='20px'>
        ...
        <Flex align='center' justify='center'>
          <Select
            ...
            maxW='80%'
            mr={3}
            onChange={(e) => setOpcoChoice(e.target.value)}
          >
            <option value='' hidden>
              Sélectionnez un OPCO
            </option>
            <option value='AFDAS'>AFDAS</option>
            <option value="AKTO / Opco entreprises et salariés des services à forte intensité de main d'oeuvre">
              AKTO
            </option>
            ...
            <option value="Uniformation, l'Opco de la Cohésion sociale">
              Uniformation, l'Opco de la Cohésion sociale
            </option>
          </Select>
          <Button
            isDisabled={opcoChoice === undefined}
            isActive={opcoChoice !== undefined}
            variant='form'
            px={5}
            onClick={setValidateOpcoChoice.toggle}
          >
            Valider
          </Button>
        </Flex>
