    ...
    <Layout>
      ...
      <Box w='100%' py={[4, 8]} px={[1, 1, 12, 24]} color='#1E1E1E'>
        <Container maxW='xl'>
          ...
          <Box pt={4} pb={16} mt={8}>
            <Text>
              « RDV Apprentissage » est un service créé par la Mission Nationale de l’apprentissage dans le but de
              faciliter la mise en relation entre les candidats et les centres de formation en apprentissage (CFA).
              Grâce à un simple bouton présent sur les plateformes exposant les formations en apprentissage sur
              internet, les candidats peuvent demander aux CFA qui les intéressent de les recontacter par téléphone ou
              par mail.
              <br />
              <br />
              En facilitant cette première prise de contact, le service vise à fluidifier et à sécuriser le parcours des
              ...
              disponible depuis janvier 2021.
              <br />
              <br />
            </Text>
          </Box>
