...
export const wrongApplicationTestFile =
...
// File with mismatched header and content (PDF header but PNG content)
// This tests the case where header matches filename but actual content is different
export const mismatchedHeaderContentTestFile =
