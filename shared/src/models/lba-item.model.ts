...
const ZLbaItemPlace = z.strictObject({
  distance: z
    .number()
...
const ZLbaItemRome = z.strictObject({
  code: z
    .string()
...
const ZLbaItemNaf = z.strictObject({
...
const ZLbaItemContact = z.strictObject({
...
const ZLbaItemCompanyHQ = z.strictObject({
...
const ZLbaItemOpco = z.strictObject({
...
const ZLbaItemCompany = z.strictObject({
  name: z
    .string()
...
const ZLbaItemJob = z.strictObject({
  ...
  isCfaEntreprise: z.boolean().nullish(), // issu de la liste des cfa d'entreprise cf shared/src/services/is-cfa-entreprise.ts
...
const ZLbaItemTrainingSession = z.strictObject({
...
const ZLbaItemTraining = z.strictObject({
...
const ZLbaItemTraining2 = z.strictObject({
...
export const ZLbaItemFormation2 = z.strictObject({
...
export const ZLbaItemLbaJob = z.strictObject({
...
export const ZLbaItemPartnerJob = z.strictObject({
...
export const ZLbaItemLbaCompany = z.strictObject({
...
export const ZLbaItemFtJob = z.strictObject({
...
export const ZLbaItemFormationResult = z.strictObject({
