...
const etablissementGestionnaireSchema = z.strictObject({
...
const etablissementReferenceSchema = z.strictObject({
...
export const zFormationCatalogueSchema = z
  .object({
    ...
    rncp_details: z.record(z.string(), z.unknown()).nullish(),
    ...
    parcoursup_statut_history: z.array(z.record(z.string(), z.unknown())).nullish(),
    ...
    affelnet_statut_history: z.array(z.record(z.string(), z.unknown())).nullish(),
    ...
    updates_history: z.array(z.record(z.string(), z.unknown())).nullish(),
    ...
    bcn_mefs_10: z.array(z.record(z.string(), z.unknown())).nullish(),
    editedFields: z.record(z.string(), z.unknown()).nullish(),
