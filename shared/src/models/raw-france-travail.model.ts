...
export const ZFTJobRaw = z.looseObject({
  _id: zObjectId,
  createdAt: z.date(),
  updatedAt: z.date(),
  ...
  competences: z.array(z.looseObject({ code: z.string().optional(), libelle: z.string(), exigence: z.string() })).optional(),
  permis: z.array(z.looseObject({})).optional(),
  salaire: z.union([z.array(z.looseObject({})), z.looseObject({})]),
  ...
  agence: z.union([z.array(z.looseObject({})), z.looseObject({})]).optional(),
