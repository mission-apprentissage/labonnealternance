...
import { detectUrlAndEmails, detectUrls } from "../utils/detect-url-and-emails.js"
...
export const ZDelegation = z.strictObject({
...
export const ZJobFields = z.strictObject({
  ...
  job_start_date: z.coerce.date<Date>().describe("Date de début de l'alternance"),
...
export const ZNewDelegations = z.strictObject({
