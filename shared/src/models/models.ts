...
const modelDescriptorMap = {
  ...
  [anonymizedUsersWithAccountsModel.collectionName]:
    anonymizedUsersWithAccountsModel,
  ...
  [referentielEngagementEntrepriseModel.collectionName]:
    referentielEngagementEntrepriseModel,
...
export type IDocument<Name extends CollectionName> = z.output<
