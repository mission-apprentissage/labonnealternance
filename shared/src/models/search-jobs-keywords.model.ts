...
const collectionName = "search_jobs_keywords" as const

/**
 * Cache des mots-clés générés par Mistral pour les offres indexées, keyé par le HASH du texte
 ...
 * flux) ne coûtent ainsi qu'un seul appel. Une régénération de l'index ne perd pas
 * les keywords.
 *
 ...
 */
export const ZSearchJobKeywords = z.object({
  _id: zObjectId,
...
export type ISearchJobKeywords = z.output<typeof ZSearchJobKeywords>

export default {
  zod: ZSearchJobKeywords,
