...
export const ZJobsPartnersRecruiterApi = z.object({
  ...
  workplace_address_label: z.string().nullable().describe("Adresse complète provenant du SIRET ou du partenaire"),
  ...
  workplace_address_country: z.string().nullable().describe("Pays, provenant du SIRET ou du partenaire"),
