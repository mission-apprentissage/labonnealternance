...
export const ZDomainesMetiers = z
  .object({
    ...
    sous_domaine_sans_accent: z.string(),
    domaine: z.string(),
    domaine_sans_accent: z.string(),
    codes_romes: z.array(z.string()),
    intitules_romes: z.array(z.string()),
    intitules_romes_sans_accent: z.array(z.string()),
    codes_rncps: z.array(z.string()),
    intitules_rncps: z.array(z.string()),
    intitules_rncps_sans_accent: z.array(z.string()),
    mots_clefs: z.string(),
    mots_clefs_sans_accent: z.string(),
    mots_clefs_specifiques: z.string(),
    mots_clefs_specifiques_sans_accent: z.string(),
    appellations_romes: z.string(),
    appellations_romes_sans_accent: z.string(),
    codes_fap: z.array(z.string()),
    intitules_fap: z.array(z.string()),
    intitules_fap_sans_accent: z.array(z.string()),
    sous_domaine_onisep: z.array(z.string()),
    sous_domaine_onisep_sans_accent: z.array(z.string()),
