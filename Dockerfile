FROM platformatic/node-caged:26.3.1-slim AS builder_root
WORKDIR /app
...
FROM platformatic/node-caged:26.3.1-slim AS server
WORKDIR /app
...
FROM platformatic/node-caged:26.3.1-slim AS ui
WORKDIR /app
