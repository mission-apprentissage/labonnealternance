        ...
        <GridItem px={4} colSpan={[12, 12, 12, 7]}>
          <Box className="">
            ...
            <Text as="p" mb="3">
              ...
              <br />
              Tél. :{" "}
              <Link variant="editorialContentLink" href="tel:+33140306000" aria-label="Appel du numéro +33140306000" title="01 40 30 60 00">
                01 40 30 60 00
              </Link>
              <br />
            </Text>
            ...
            <Text as="p" mb="3">
              ...
              <br />
              Tél. :{" "}
              <Link variant="editorialContentLink" href="tel:+33972101007" aria-label="Appel du numéro +33972101007" title="09 72 10 10 07">
                09 72 10 10 07
              </Link>
            </Text>
            ...
            <Text as="p" mb="3">
              L&apos;accessibilité du Web signifie que les personnes en situation de handicap peuvent utiliser le Web. Plus précisément, qu&apos;elles peuvent percevoir,
              comprendre, naviguer et interagir avec le Web, et qu&apos;elles peuvent contribuer sur le Web. L&apos;accessibilité du Web bénéficie aussi à d&apos;autres, notamment
              les personnes âgées dont les capacités changent avec l&apos;âge. L&apos;accessibilité du Web comprend tous les handicaps qui affectent l&apos;accès au Web, ce qui
              inclut les handicaps visuels, auditifs, physiques, de paroles, cognitives et neurologiques.
            </Text>
            <Text as="p" mb="3">
            ...
            <Text as="p" mb="3">
              ...
              <Link variant="editorialContentLink" href="https://github.com/mission-apprentissage/labonnealternance" aria-label="Accès à Github" title="Github" isExternal>
                Github
              </Link>
              .
            </Text>
            ...
            <Text as="p" mb="3">
              Le site est protégé par un certificat électronique, matérialisé pour la grande majorité des navigateurs par un cadenas. Cette protection participe à la
