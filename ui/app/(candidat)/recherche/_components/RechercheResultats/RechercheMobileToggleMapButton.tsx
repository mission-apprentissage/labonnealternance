...
export function RechercheMobileToggleMapButton({ displayMap, params }: { params: IRecherchePageParams; displayMap: boolean }) {
  const navigateToRecherchePage = useNavigateToRecherchePage(params)
