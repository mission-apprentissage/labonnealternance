...
import { useSearchViewNotifier } from "@/app/(candidat)/(recherche)/recherche/_hooks/use-search-view-notifier"
import { useWhispers } from "@/app/(candidat)/(recherche)/recherche/_hooks/use-whispers"
