...
export default async function UnJeuneUneSolutionLayout({ children }: PropsWithChildren) {
  return (
    <>
      <SkipLinks
        links={[
          { label: "Contenu", anchor: `#${mainId("1jeune1solution-recruteurs")}` },
          { label: "Pied de page", anchor: `#${footerId("1jeune1solution-recruteurs")}` },
        ]}
      />
      ...
      <Box component="main" role="main" id={mainId("1jeune1solution-recruteurs")} tabIndex={-1}>
        {children}
      </Box>
      <Footer zone="1jeune1solution-recruteurs" />
    </>
  )
}
