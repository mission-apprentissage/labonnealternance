            ...
            <Grid size={12} mx={fr.spacing("4w")}>
              <List sx={{ listStyleType: "disc", ml: 2, pl: 2, mb: 2 }} disablePadding dense>
                ...
                <ListItem sx={{ display: "list-item" }}>
                  ...
                  <DsfrLink href="https://entreprendre.service-public.gouv.fr/vosdroits/F23556">En savoir plus</DsfrLink>
                </ListItem>
                <ListItem sx={{ display: "list-item" }}>
                  ...
                  <DsfrLink href="https://annuaire-entreprises.data.gouv.fr/">En savoir plus</DsfrLink>
                </ListItem>
                <ListItem sx={{ display: "list-item" }}>
                ...
                <ListItem sx={{ display: "list-item" }}>
                  ...
                  <DsfrLink href="https://entreprendre.service-public.gouv.fr/vosdroits/F23556">DREETS</DsfrLink>) sont les services déconcentrés du Ministère du Travail, de la
                  Santé et des Solidarités. Vous pouvez les contacter pour toute question relative au contrat d’apprentissage et de professionnalisation, au droit du travail, à
                  l’activité des organismes de formation.
                </ListItem>
                <ListItem sx={{ display: "list-item" }}>
                  L’<DsfrLink href="https://www.asp.gouv.fr/">Agence de services et de paiement</DsfrLink> (ASP) est l’opérateur de l’État chargé du paiement des aides publiques.
                ...
                <ListItem sx={{ display: "list-item", flex: "1" }}>
                  Le contrat en apprentissage <DsfrLink href="https://www.service-public.gouv.fr/particuliers/vosdroits/R1319">Cerfa n° 10103*11</DsfrLink> doit être signé et
                  transmis à votre OPCO{" "}
                  <Typography component="span" fontWeight={700}>
                  ...
                  <DsfrLink href="https://quel-est-mon-opco.francecompetences.fr/">CERFA dématérialisé</DsfrLink>
                </ListItem>
