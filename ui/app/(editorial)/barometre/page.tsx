...
const COLOR_SPONTANEES = fr.colors.decisions.background.actionHigh.greenEmeraude.default
const COLOR_REPONSE = fr.colors.decisions.background.actionHigh.purpleGlycine.default
const COLOR_REDIRECTION = fr.colors.decisions.background.actionHigh.orangeTerreBattue.default
...
const strong = (s: string) => (
  <Typography
    ...
    sx={{
      fontWeight: 700,
      backgroundImage: `linear-gradient(to top, ${fr.colors.decisions.background.alt.blueFrance.default} 38%, transparent 38%)`,
...
export default function BarometrePage() {
  return (
    <Box>
      ...
      <DefaultContainer>
        <Box component="article" sx={{ maxWidth: "900px", mx: "auto", pb: fr.spacing("16v") }}>
          <Typography component="p" sx={{ fontSize: "14px", color: fr.colors.decisions.text.mention.grey.default, mb: fr.spacing("2v") }}>
            Publié le 13 mai 2026
          </Typography>

          <SectionTitle component="h1" title="Le marché de l’alternance" highlightedText="au premier trimestre 2026 sur La bonne alternance" fontSize="40px" lineHeight="48px" />
          ...
          >
            <Typography component="p" sx={{ fontStyle: "italic", color: fr.colors.decisions.text.default.grey.default, m: 0 }}>
          ...
          <Callout variant="highlight">
            ...
            <Box component="ul" sx={{ pl: fr.spacing("4v"), m: 0, "& > li": { mb: fr.spacing("2v") } }}>
              ...
              <li>
                <strong>Un déséquilibre par métier</strong>&nbsp;: une forte concentration de candidats sur certains métiers, tandis que d’autres secteurs manquent de candidatures.
              </li>
              <li>
          ...
          <Typography component="p" sx={paragraphSx}>
            La saisonnalité est clé&nbsp;: le premier trimestre est un trimestre de démarrage, alors que le deuxième trimestre concentre le pic de recrutements, comme le montrent
            les{" "}
          ...
          <Typography component="p" sx={paragraphSx}>
            Les offres {strong("actives")} sur La bonne alternance au premier trimestre 2026 reflètent une concentration marquée sur les métiers de la restauration et du commerce
            de proximité. Les 10 premiers métiers du classement appartiennent tous à ces deux univers&nbsp;: de l’agent de cuisine au vendeur en boulangerie, en passant par le
            conseiller de vente et l’employé de libre-service. Une tendance cohérente avec la structure de l’apprentissage en France, où les niveaux infrabac et CAP restent très
            présents, et où la restauration constitue historiquement le premier secteur recruteur en alternance.
          </Typography>
          ...
          <Callout variant="highlight">
            <Typography component="p" sx={{ m: 0 }}>
              👉 Sur La bonne alternance, les offres restent dominées par la restauration et le commerce, mais la présence croissante du tertiaire — comme le conseil, la gestion et
              la comptabilité — traduit une diversification progressive des recruteurs qui déposent sur la plateforme. Un signal utile pour mieux orienter les candidats vers les
              filières où les opportunités se développent.
            </Typography>
          </Callout>
          ...
          <Typography component="p" sx={paragraphSx}>
            Sur La bonne alternance, l’activité des candidats reste soutenue&nbsp;: près de {strong("320 000 candidatures")} ont été déposées au premier trimestre 2026, soit une
            progression de {positive("+7 %")} par rapport au premier trimestre 2025.
          </Typography>

          <Typography component="p" sx={paragraphSx}>
            La lecture mensuelle est encore plus révélatrice. Janvier et février s’inscrivent dans la continuité d’un quatrième trimestre 2025 en retrait, avant que mars ne rompe
            avec cette tendance&nbsp;: {positive("+58 %")} sur un an, avec un volume de candidatures qui double par rapport à février.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            ...
            postuler&nbsp;; une tension accrue sur le marché&nbsp;; et l’impact mesurable des travaux de l’équipe La bonne alternance pour améliorer le référencement naturel de la
            plateforme.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            À l’opposé, la quasi-absence de candidatures sur La bonne alternance pour des métiers comme <em>cariste, bobinier, ajusteur-monteur</em> ou <em>aide agricole</em> ne
            reflète probablement pas un manque d’opportunités. Elle pourrait davantage traduire un décalage entre l’outil numérique et les réalités de ces secteurs. Pour ces
            métiers, le recrutement passerait potentiellement par des canaux alternatifs&nbsp;: l’intérim pour la logistique et l’industrie, les groupements d’employeurs et réseaux
            de proximité pour l’agriculture, la cooptation directe entre CFA et entreprises partenaires pour les métiers spécialisés. À cela s’ajouterait une familiarité moindre
            avec les outils numériques comme La bonne alternance.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            Ces résultats doivent toutefois être interprétés avec prudence, car les volumes restent faibles, entre {strong("18 et 96 candidatures")} selon les métiers. Un faible
            niveau de concurrence sur La bonne alternance ne signifie donc pas automatiquement une insertion plus facile, mais plutôt une{" "}
          ...
          <Typography component="p" sx={paragraphSx}>
            Dans un marché sous tension, La bonne alternance agit là où elle peut avoir un impact concret&nbsp;: réduire les frictions, élargir l’accès et mettre en relation ceux
            qui cherchent avec ceux qui recrutent, indépendamment de leur réseau, de leur territoire ou de leur niveau de qualification. C’est cette ambition de service public qui
            guide les actions engagées au premier trimestre 2026 et que les données commencent à refléter.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            ...
            diplôme le plus recherché par les recruteurs ({strong("28 %")}), devant les offres sans exigence de diplôme spécifique ({strong("25 %")}). Les niveaux Infrabac restent
            toutefois bien représentés, avec {strong("901 offres")} CAP et autres formations Infrabac, soit le troisième niveau le plus demandé sur la plateforme ({strong("15 %")}
            ).
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            ...
            passés des entreprises, leurs données financières et les candidatures déjà reçues, la plateforme établit une liste ciblée d’entreprises à fort potentiel d’embauche en
            alternance permettant aux candidats d’engager des démarches spontanées éclairées, sans réseau préalable.
          </Typography>

          <Typography component="p" sx={paragraphSx}>
            Au premier trimestre 2026, près de {strong("8 candidatures sur 10")} sont des candidatures spontanées sur La bonne alternance, marqueur structurel d’un trimestre où les
            offres publiées n’ont pas encore atteint leur pic, mais où les candidats sont déjà en recherche active.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            Les métiers les plus sous tension — numérique, tertiaire qualifié, fonctions support — sont aussi ceux où les candidats se tournent le plus vers la démarche spontanée,
            faute d’offres suffisantes. La candidature spontanée devient une réponse rationnelle à un marché visible insuffisant.
          </Typography>
          ...
          <Typography component="p" sx={paragraphSx}>
            Au-delà de l’agrégation et de la mise en relation, La bonne alternance s’attache à garantir la fiabilité de l’expérience candidat. Un dispositif de contrôle qualité des
            offres permet d’identifier et d’écarter les offres obsolètes ou frauduleuses, un enjeu non négligeable dans un marché où les fausses offres constituent un frein réel à
            l’engagement des candidats.
          </Typography>

          <Typography component="p" sx={paragraphSx}>
            En parallèle, la plateforme continue de renforcer son maillage avec l’écosystème de l’alternance, notamment à l’échelle territoriale. Ce travail de fond — partenariats
            avec les CFA, les missions locales, les opérateurs de compétences et les acteurs de l’insertion — se traduit par des actions d’accompagnement ciblées, pensées pour
            atteindre les candidats les plus éloignés du marché et les aider à concrétiser leur projet d’alternance, là où une plateforme seule ne suffirait pas.
          </Typography>
          ...
          <Callout variant="watch">
            ...
            <Typography component="p" sx={{ m: 0 }}>
              Le deuxième trimestre sera un révélateur de la trajectoire du marché de l’alternance. C’est historiquement le pic annuel&nbsp;: les vœux Parcoursup se concrétisent,
              les entreprises lancent leurs campagnes de recrutement pour la rentrée de septembre, et les volumes d’offres atteignent leur maximum. La question centrale est l’effet
              de la dernière baisse des aides sur ce cycle saisonnier.
            </Typography>
            <Typography component="p" sx={{ mt: fr.spacing("3v"), m: 0, fontStyle: "italic" }}>
              Les entreprises vont-elles maintenir leur rythme de publication d’offres malgré un soutien public amoindri, ou le deuxième trimestre 2026 marquera-t-il le premier pic
              saisonnier en recul ?
            </Typography>
          </Callout>
        </Box>
