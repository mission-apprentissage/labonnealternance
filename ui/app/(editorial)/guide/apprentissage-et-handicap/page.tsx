  ...
  return (
    ...
    >
            ...
            listItems={[
              <>
                <Typography component="span" fontWeight={"bold"}>
                  dès l’âge de 16 ans (sauf dérogation) et sans limite d’âge maximal (contrairement au contrat d’apprentissage de droit commun) pour :
                </Typography>
              </>,
            ]}
          />
          <Box sx={{ ml: fr.spacing("10v"), mt: 0 }}>
            <ParagraphList
              listItems={[
                ...
                "les personnes bénéficiaires de l'obligation d'emploi (BOE), à l’exception des ayants droit de victimes ou pensionnés de guerre ;",
              ]}
            />
          </Box>
          <ParagraphList
            listItems={[
              <>
                <Typography component="span" fontWeight={"bold"}>
                  aux jeunes âgés de 15 à 20 ans (“équivalences jeunes”), qui bénéficient soit :
                </Typography>
              </>,
            ]}
          />
      ...
      <Section title="Quelle est la durée du contrat ?">
        ...
        <Paragraph>
          <Typography fontWeight={"bold"} component={"span"}>
            La durée maximale du contrat d'apprentissage aménagé peut, elle, être portée jusqu’à 4 ans maximum pour les personnes en situation de handicap.
          </Typography>{" "}
          En effet, en fonction des besoins de l’apprenti en situation de handicap, l’enseignement délivré par le CFA en vue de conduire au diplôme prévu au contrat, est réparti
          sur une période égale à la durée habituelle d’apprentissage pour la formation considérée, augmentée d’un an au plus.
        </Paragraph>
      </Section>
      <Section title="Comment se déroule la formation ?">
        <Paragraph>La formation peut se dérouler dans l’ensemble des centres de formation d’apprentis (CFA).</Paragraph>
        <Paragraph>
      ...
      <Section title="Quelle est la rémunération ?">
        <Paragraph>
          Comme tous les apprentis, la personne en situation de handicap est rémunérée en pourcentage du Smic ou du SMC (salaire minimum conventionnel de l’emploi occupé pour les
          21 ans et plus), variable selon son âge et sa progression dans le ou les cycles de formation faisant l’objet de l’apprentissage.
        </Paragraph>
        <Paragraph>
          ...
          minimum perçu par l’apprenti correspond à un pourcentage du Smic ou du salaire minimum conventionnel.
        </Paragraph>
        <TableArticle
      ...
      <Section title="Le recrutement et, le cas échéant, la titularisation d’apprentis BOETH dans la fonction publique">
        ...
        <Paragraph>
          La titularisation des apprentis BOETH à l’issue de leur contrat d’apprentissage dans la fonction publique n’est pas automatique : il est nécessaire que l’apprenti se
          porte candidat et que l’employeur public décide de le titulariser en tenant compte notamment des capacités du candidat à exercer les missions, de sa motivation, du bilan
          de la période d'apprentissage, de son parcours professionnel ainsi que de ses connaissances sur l'environnement professionnel de l'emploi ou des emplois faisant l'objet
          de sa candidature.
        </Paragraph>
        <Paragraph>
