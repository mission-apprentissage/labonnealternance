  ...
  return (
    <DefaultContainer>
      <Grid container mt={fr.spacing("4w")}>
        <Grid size={{ md: 6, xs: 12 }} spacing={{ md: fr.spacing("8w"), xs: fr.spacing("4w") }}>
        ...
        <Grid size={{ md: 6, xs: 12 }}>
          <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-votre-besoin.svg"} alt="" width={716} height={414} unoptimized style={{ width: "100%" }} />
        </Grid>
      </Grid>
      <Grid
        container
        sx={{
          mt: { md: fr.spacing("8w"), xs: fr.spacing("4w") },
      ...
      >
        <Grid size={{ md: 6, xs: 12 }} sx={{ my: "auto" }}>
          <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-offre-emploi.svg"} alt="" width={529} height={281} unoptimized style={{ width: "100%" }} />
        </Grid>
        ...
        <Grid container display={"flex"} flexDirection={{ md: "row", xs: "column-reverse" }}>
          ...
          <Grid size={{ md: 6, xs: 12 }} sx={{ my: "auto" }}>
            <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-plateforme-jeunes.svg"} alt="" width={504} height={292} unoptimized style={{ width: "100%" }} />
          </Grid>
        </Grid>
        <Grid size={{ md: 6, xs: 12 }} sx={{ my: "auto" }}>
          <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-soliciter-cfa.svg"} alt="" width={561} height={378} unoptimized style={{ width: "100%" }} />
        </Grid>
        <Grid size={{ md: 6, xs: 12 }} sx={{ my: "auto", px: { md: fr.spacing("2w") } }}>
          <Typography component={"h2"} variant={"h3"}>
      ...
      >
        <Grid size={12} sx={{ display: "flex", flexDirection: "column", my: "auto", justifyContent: "center" }}>
          <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-lba.svg"} alt="" width={212} height={145} unoptimized style={{ width: "100%", margin: "auto" }} />
          <Typography component={"h2"} variant={"h4"} align="center">
            Pour vous aider dans vos démarches de recrutement en alternance
          </Typography>
        </Grid>
        <Grid container spacing={2} sx={{ mt: fr.spacing("4v") }}>
          <Grid size={{ md: 6, xs: 12 }}>
            <Card
      ...
      >
        ...
        <Grid size={{ md: 5, xs: 12 }} sx={{ mb: "auto" }}>
          <Image fetchPriority="low" src={"/images/je-suis-recruteur/illu-marche-cache.svg"} alt="" width={398} height={431} unoptimized style={{ width: "100%" }} />
        </Grid>
      </Grid>
      <Grid container spacing={4} sx={{ mt: fr.spacing("8w") }}>
        <Grid size={12}>
        ...
        <Grid size={12} sx={{ display: "flex", flexDirection: "row", my: "auto", justifyContent: "center" }} gap={2}>
          <Button linkProps={{ href: PAGES.static.espaceProCreationEntreprise.getPath() }} priority="primary">
            Déposer une offre
          </Button>
          <Button linkProps={{ href: PAGES.static.authentification.getPath() }} priority="secondary">
      ...
      <Grid
        ...
        spacing={4}
      >
        <Grid size={{ md: 9, xs: 12 }} display={"flex"} flexDirection={"column"} gap={2}>
