      ...
      <SimpleGrid columns={{ sm: 1, md: 2 }} spacing="40px">
        ...
        <Box>
          <Box>
            ...
            <Box>Un accès multi-comptes permettra à plusieurs personnes de votre entreprise d’accéder et de gérer vos offres d&apos;emploi.</Box>
          </Box>
          <Box mt={{ base: "2", lg: "5" }}>
            <Text as="h2" variant="homeEditorialH2" mb={{ base: "1", lg: "2" }}>
              Consultez et gérez vos candidatures
            </Text>
            <Box>Vérifiez d&apos;un coup d&apos;œil la progression des candidatures pour définir les prochaines étapes.</Box>
          </Box>
        </Box>
      </SimpleGrid>
    </Box>
