                              ...
                              <Box component="tr" key={i} sx={{ _hover: { bg: "#f4f4f4", transition: "0.5s" } }}>
                                ...
                                <Box component="td" align="center" sx={{ fontSize: "0.8em", px: "1px", verticalAlign: "top !important", width: "350px" }}>
                                  <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                    <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                      <InfoTooltip label="Informations sur DESACTIVER">Désactiver l'écrasement du mail via la synchronisation catalogue</InfoTooltip>
                                  ...
                                  <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                    <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                      <InfoTooltip label="Informations sur PUBLIÉ">Publié sur le catalogue</InfoTooltip>
                                  ...
                                  <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                    <Box sx={{ display: "flex", flexDirection: "row", gap: 0 }}>
                                      <InfoTooltip label="Informations sur SYNCHRO">Dernière synchronisation catalogue</InfoTooltip>
