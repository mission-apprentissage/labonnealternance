...
export const HowTo = () => (
  ...
  >
    ...
    >
      <Image fetchPriority="high" priority src="/images/howto1.svg" alt="" unoptimized width={286} height={141} style={{ width: "100%" }} />
    ...
    >
      <Image fetchPriority="high" priority src="/images/howto2.svg" alt="" unoptimized width={299} height={145} style={{ width: "100%" }} />
      <Box sx={{ display: "flex", flexDirection: "column", gap: fr.spacing("2v") }}>
    ...
    >
      <Image fetchPriority="high" priority src="/images/howto3.svg" alt="" unoptimized width={285} height={140} style={{ width: "100%" }} />
      <Box sx={{ display: "flex", flexDirection: "column", gap: fr.spacing("2v") }}>
