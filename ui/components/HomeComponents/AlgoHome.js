    ...
    <section className="c-algo container">
      <div className="">
        ...
        <ul className="c-algo-text">
          <li>
            <strong>Les offres d'emploi</strong> : publiées sur notre plateforme ainsi que celles issues de Pôle emploi
            et ses partenaires. Elles sont identifiées grâce au tag <TagOffreEmploi />
          </li>
          <li className="pt-3">
            <strong>Les candidatures spontanées</strong> : correspondant au marché caché de l'emploi. Chaque mois, un
            algorithme prédictif de Pôle emploi analyse les recrutements des 6 années passées pour prédire ceux des 6
            mois à venir. Grâce à ces données, il identifie une liste restreinte d'entreprises "à fort potentiel
            d'embauche en alternance" pour faciliter vos démarches de candidatures spontanées. Elles sont identifiées
            grâce au tag <TagCandidatureSpontanee />
          </li>
        </ul>
      </div>
