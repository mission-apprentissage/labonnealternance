  ...
  return (
    <Box as="section" p={3} mb={{ base: '2', md: '5' }} >
      <SimpleGrid columns={{ sm: 1, md: 2 }} spacing='40px'>
        <Box>
          <Text as="h1" fontSize="32px" color={"#000091"} lineHeight={"40px"} fontWeight={"700"}>Vous êtes une entreprise</Text>
          <Text as="h2" variant="pageEntrepriseH2" mb={{ base: '3', lg: '5' }}>Diffusez simplement et gratuitement vos offres en alternance.</Text>
          <Box fontWeight={"500"}>
