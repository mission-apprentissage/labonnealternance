      ...
      <div className="row">
        <div className="col-12 col-md-6 d-none d-md-block">
          <img
            ...
            src="/images/home_pics/illu-entreprisesmandatees.svg"
            alt=""
          />
        </div>
        <div className="col-12 col-md-6 order-md-first">
          <h1 className="c-homecomponent-title c-homecomponent-title__blue mb-3">
          ...
          <div>
            Créez le compte de votre CFA pour administrer vos offres et être contacté par des entreprises à la recherche
            d’alternants.
          </div>
