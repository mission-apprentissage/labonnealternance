      ...
      <Box py={12} backgroundColor="#f5f5fe">
        <Grid templateColumns={{ base: "repeat(1, 1fr)", lg: "repeat(5, 1fr)" }} spacing="20px">
          <GridItem colSpan={{ base: "1", lg: "3" }}  px="12">
            ...
            <UnorderedList>
              <ListItem mb="3"><strong>Celles ayant émis un besoin en recrutement </strong>sur notre plateforme ainsi que sur Pôle emploi et ses sites partenaires</ListItem>
              <ListItem mb="3">
