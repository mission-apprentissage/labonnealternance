...
export default function ItemDetailCard({ selectedItem }: { selectedItem: ILbaItemJobsGlobal }) {
  const res = selectedItem?.company?.mandataire ? (
    <Box sx={{ color: "grey.700", textAlign: "left", mt: fr.spacing("4v"), mb: fr.spacing("2v") }}>
      ...
      >
        <svg aria-hidden={true} width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <Typography component="span">&nbsp;Entreprise :&nbsp;</Typography>
      ...
      >
        ...
        <Typography component="span">&nbsp;Formation :&nbsp;</Typography>
