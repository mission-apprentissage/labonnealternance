  ...
  return (
    item?.company?.mandataire && (
      <Box sx={{ display: "flex", flexDirection: "row", width: "95%", alignItems: "center" }}>
        ...
        <Typography sx={{ ml: fr.spacing("6v") }}>Votre candidature sera envoyée au centre de formation en charge du recrutement pour le compte de l&apos;entreprise.</Typography>
      </Box>
    )
  )
}
