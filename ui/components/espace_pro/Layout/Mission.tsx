  ...
  return (
    <Container maxW="container.xl">
      <Grid templateColumns={["1fr", "5fr 7fr"]} gap={5} alignItems="center" pb={4}>
        ...
        <GridItem>
          <Text pb={4}>
            « RDV Apprentissage » est un module destiné à s’intégrer aux plateformes et portails exposant les formations en apprentissage pour faciliter le premier contact entre
            les candidats à l’apprentissage et les Centres de Formation des Apprentis (CFA)
          </Text>
