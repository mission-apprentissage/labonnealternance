...
export default async function postIntention(params, _apiEndpoint = apiEndpoint, _axios = axios, _window = window, _logError = logError) {
  let res = ""

  const candidatureApi = _apiEndpoint + "/application/intention"
