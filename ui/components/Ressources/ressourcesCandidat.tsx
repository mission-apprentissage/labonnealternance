import { Accordion, AccordionButton, AccordionItem, AccordionPanel, Box, Grid, GridItem } from "@chakra-ui/react"
      ...
      <Accordion defaultIndex={[0]} allowMultiple>
        <AccordionItem>
          ...
          <AccordionPanel>
            <ul>
              ...
              <li>
                L’alternance augmente d'environ 10% vos chances de trouver un emploi en sortie de formation, par rapport à une formation scolaire. Et ce, car l'alternance vous
                permet d'acquérir une première expérience professionnelle. En contrepartie, c’est un mode de formation exigeant qui implique un rythme de travail professionnel,
                avec des congés limités et non plus de vacances scolaires.
              </li>
        ...
        <AccordionItem>
          ...
          <AccordionPanel>
            ...
            un emploi dans les 6 mois après avoir obtenu le diplôme que vous souhaitez préparer ? La réponse ici ! En savoir plus Certains établissements de formation obtiennent
            des labels d'excellence, c'est par exemple le cas des CMQ (Campus des Métiers et Qualifications d'excellence). En savoir plus
          </AccordionPanel>
        </AccordionItem>
        ...
        <AccordionItem>
          ...
          <AccordionPanel>
            Tout au long de l'année, il existe des salons de recrutement (physiques ou virtuels) spécialisés pour l'alternance : renseignez-vous ! Voir les salons l’Étudiant Voir
            les salons Studyrama France Travail recense de nombreux évènements (conférences, salons, job dating, conférences en ligne…) pour vous aider dans vos recherches de
            contrat. En savoir plus La loi « Avenir professionnel » a étendu les possibilités de faire un contrat en alternance à l’étranger, dans ou hors de l’Union européenne.
            Cela vous intéresse ? Découvrir les offres d'emploi à l'étranger Le secteur public (mairies, ministères, départements, régions, ...) recrute aussi des alternants,
            pensez-y ! En savoir plus Plus d’un employeur sur deux recrute sans déposer d'offre d'emploi : optimisez vos chances en adressant aussi des candidatures spontanées !
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionPanel>
            ...
            Motivation, Dynamisme et Présentation soignée : 3 qualités recherchées par les employeurs de jeunes candidats. Mettez-les en avant dans votre candidature ! Les
            recruteurs font attention à de petits détails ! Professionnalisez vos candidatures en utilisant une adresse email adaptée aux contacts professionnels (par exemple :
        ...
        <AccordionItem>
          ...
          <AccordionPanel>
            ...
            renseignez-vous auprès de votre mairie et de votre opérateur de transport ! De nombreuses aides existent pour les jeunes : pour les connaître, faites une simulation sur
            1 jeune 1 solution ! En savoir plus
          </AccordionPanel>
        </AccordionItem>
      </Accordion>
      <Box>
