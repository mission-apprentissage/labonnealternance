...
import { Box, Flex, Image, UnorderedList, ListItem, Text, Link, Center } from "@chakra-ui/react"
      ...
      <Box>
        ...
        <UnorderedList>
          ...
          <ListItem mb={4}>
            ...
            Il s’agit de votre interlocuteur de proximité pour vos démarches liées à l’alternance (financement des contrats, formation, ...). Votre OPCO peut vous aider à affiner
            vos besoins de recrutement. Aussi, sachez qu’en déposant une offre d’emploi en alternance sur le site de votre OPCO, celle-ci sera rediffusée sur les sites consultés
            par les jeunes.
            <br />
          ...
          <ListItem mb={4}>
            <Link href="https://travail-emploi.gouv.fr/IMG/pdf/precis-apprentissage.pdf" aria-label="Accéder au précis de l'appretnissage" isExternal variant="basicUnderlinedBlue">
