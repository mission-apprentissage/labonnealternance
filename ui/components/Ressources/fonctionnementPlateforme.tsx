...
const FonctionnementPlateforme = () => {
  return (
    <Box
      sx={{ display: "flex", p: fr.spacing("10v"), flexDirection: { xs: "column", md: "row" }, backgroundColor: "#f6f6f6", alignItems: "center", justifyContent: "space-between" }}
    >
      <Stack spacing={2}>
      ...
      <Box sx={{ mt: { xs: fr.spacing("4v"), md: 0 } }}>
