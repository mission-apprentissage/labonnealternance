    ...
    content: (
      <Box>
        <UnorderedList>
          ...
          <ListItem mb={4}>Plus d’un employeur sur deux recrute sans déposer d'offre d'emploi : optimisez vos chances en adressant aussi des candidatures spontanées !</ListItem>
        </UnorderedList>
      </Box>
    ),
  },
